...
<p align="center">
  ...
  <em>Slika 3.1: Interne strukture jezgre za proces s dvije otvorene datoteke. Deskriptori datoteka 0 (standard input), 1 (standard output) i 2 (standard error) otvoreni su automatski pri pokretanju.</em>
</p>
...
<p align="center">
  ...
  <em>Slika 3.2: Dva procesa neovisno otvaraju istu datoteku: vlastiti zapis u tablici datoteka, zajednički v-node</em>
</p>
...
<p align="center">
  ...
  <em>Slika 3.3: Stanje utrke (race condition) pri dopisivanju na kraj datoteke bez zastavice <code>O_APPEND</code></em>
</p>
...
<p align="center">
  ...
  <em>Slika 3.4: Dijeljenje zapisa u tablici datoteka: procesi P1 i P2 dijele zapis nakon fork-a, proces P3 ima dva deskriptora koji pokazuju na isti zapis nakon dup (ili dup2)</em>
</p>
