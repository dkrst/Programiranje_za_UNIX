...
Nakon stvaranja cjevovoda, proces koji je pozvao `pipe()` drži oba kraja — i čitajući i pisajući deskriptor. U principu, ovaj proces sad može pisati u `fd[2]` i sam čitati to što je napisao iz `fd[0]`, dakle, razgovarati sam sa sobom, kako je prikazano na slici 7.1:

<p align="center">
  <img src="slike/cjevovod_pipe.png" alt="Proces drži oba kraja cjevovoda"><br>
  <em>Slika 7.1: Proces drži oba kraja cjevovoda — može pisati u fd[1] i čitati iz fd[0], tj. razgovarati sam sa sobom.</em>
</p>
...
<p align="center">
  ...
  <em>Slika 7.3: Stanje utrke (race condition) pri inkrementaciji dijeljenog brojača</em>
</p>
